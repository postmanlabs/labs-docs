...
* [Newman](/docs/v6/postman/collection_runs/command_line_integration_with_newman){:target="_blank"} command line tool.

* [Postman Monitors](/docs/v6/postman/monitors/intro_monitors){:target="_blank"} to run collections in scheduled intervals.
