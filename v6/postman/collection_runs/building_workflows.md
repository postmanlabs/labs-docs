...
Before you start, download and [import](/docs/postman/collections/data_formats/) [collection.json](https://assets.postman.com/postman-docs/58793802.json) for the example we'll discuss in this topic.
