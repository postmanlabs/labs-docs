...
1. In the [Integrations](https://go.postman.co/workspaces){:target="_blank"} page, find Microsoft Flow from a list of Postman’s 3rd party Integrations for Postman Pro users.
