...
![](../img/v1/docs/run_btn_ux/run_btn_ux_1.png)

When they click the Run in Postman button, they will see some options in a modal or new page depending whether you implemented the javascript button or static image. If you want a pop-up modal, use javascript. ![](../img/v1/docs/run_btn_ux/run_btn_ux_2.png)
...
![](../img/v1/docs/run_btn_ux/run_btn_ux_3.png)
...
![](../img/v1/docs/run_btn_ux/run_btn_ux_4.png)
