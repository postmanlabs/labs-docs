...
const ReferencePage = () => (
  <Layout>
    ...
    <div className="container-fluid">
      ...
      <SmallCard title="Postman Collection Schema Documentation" text="This is reference documentation for all of the various versions of Postman schemas. " href="https://learning.getpostman.com/docs/postman/launching_postman/settings/" link="Learn More" />
      ...
      within other services that render Markdown."
        ...
        link="Learn More"
      />
      <SmallCard title="Postman Settings" text="Adjust the settings within the Postman app." href="https://learning.getpostman.com/docs/postman/launching_postman/settings/" link="Learn More" />
      <SmallCard title="Keyboard Shortcuts" text="Increase your efficiency with keyboard shortcuts for the Postman app." href="https://learning.getpostman.com/docs/postman/launching_postman/navigating_postman/" link="Learn More" />
      <SmallCard
