...
Uptime monitors (open beta) continuously check the availability of a single API endpoint, website, or other URL. You'll get an email notification whenever downtime occurs, typically within 1 to 2 minutes. You can also set up an integration to get downtime notifications in Slack.
