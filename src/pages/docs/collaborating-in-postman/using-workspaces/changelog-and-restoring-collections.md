...
To review the changelog for a collection in Postman, select the __Collections__ tab in the left sidebar and click the __Changelog__ icon at the right of Postman to see a chronological list of collection activities.
