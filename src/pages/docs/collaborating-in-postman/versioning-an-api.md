...
contextual_links:
  ...
  - type: link
    name: "Create APIs directly within Postman"
...
When you create a new API in Postman, it will indicate have the version you have entered during the API creation.
...
[![API link collection to API ver](https://assets.postman.com/postman-docs/API-updating-version-tags-v8.gif)](https://assets.postman.com/postman-docs/API-updating-version-tags-v8.gif)
...
To keep the collection in sync with the schema, select the changes you require and click __Confirm Changes to Collection__.
...
To link a collection to an API version, from the **Collections** tab in the sidebar, navigate to the right side of Postman to open the **Changelog** , and click **Add Version Tag**.
