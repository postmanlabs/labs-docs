...
You can access integrations by selecting **[Home](https://go.postman.co/home)**, then **[Integrations](https://go.postman.co/integrations)** on the left. Search and select the integration you wish to add to your workspace.
