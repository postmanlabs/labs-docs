...
Using the Postman CLI, you can run Postman collections with your API tests as part of a Bitbucket pipeline.<!-- The Postman cloud reporter can send details about the collection runs back to Postman.-->
