...
To see the collection activity feed in Microsoft Power Automate:
...
1. For different types of integrations, the JSON schema varies. The following shows which schema to use for each one.
