...
For more information on types of security warnings, see [Security warnings for OpenAPI 3.0](/docs/api-security/security-warnings/openapi3) and [Security warning for OpenAPI 2.0](/docs/api-security/security-warnings/openapi2/).
