...
If your team isn't on the latest version of Postman, you can update your team to ensure everyone has access to the complete API development experience that Postman has to offer. To do so, see [Upgrading your team to the current version of Postman](/docs/administration/updating/).
