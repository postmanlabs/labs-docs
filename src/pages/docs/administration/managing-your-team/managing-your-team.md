...
To revoke an invitation, navigate to [Manage Team](https://go.postman.co/team). Hover over the individual in question, then click the corresponding trash can symbol. You can also delete invite links generated by team members by navigating to [Invite links](https://go.postman.co/settings/team/manage-invite-links) in your [Team Settings](https://go.postman.co/settings/team/general).
