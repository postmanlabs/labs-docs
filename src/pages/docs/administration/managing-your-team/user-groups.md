...
For collections, APIs, environments, mock servers, and monitors, go to the entity in Postman. In the left sidebar, select the more actions icon <img alt="More actions icon" src="https://assets.postman.com/postman-docs/icon-more-actions-v9.jpg#icon" width="16px"> to view more actions, then select **Manage roles**.
