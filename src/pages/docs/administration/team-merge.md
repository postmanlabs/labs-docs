...
* Once the last team member from your earlier team has migrated to your new one, the team will deactivate and you can begin [collaborating](/docs/collaborating-in-postman/working-with-your-team/collaboration-overview/). To learn more about collaborating in Postman, watch [Working with your team in Postman](https://youtu.be/5lscUV-Exac).
...
* Once the last team member from your earlier team has migrated to your new one, the team will deactivate and you can begin working with your team. To learn more about collaborating in Postman, watch [Working with your team in Postman](https://youtu.be/5lscUV-Exac).
