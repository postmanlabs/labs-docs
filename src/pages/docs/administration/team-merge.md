...
* Information Technology / System Administrator for Single sign-on provisioning (read more on [Business and Enterprise plans](https://www.postman.com/pricing/))
...
* Understand [what data is and is not exported in a data-dump](#migrating-your-data).
...
You can export your personal workspace and workspaces for any team you have joined. You can choose to only export collections from a workspace. See [exporting data](https://learning.postman.com/docs/getting-started/importing-and-exporting-data/#exporting-postman-data) for detail.
...
If you have an individual personal account and want to disable it and join an authorized team, you can accept the team invite and all personal Postman data will be transferred to the new team automatically.
...
* Determine ownership of workspaces, collections, and other data that may be important and would otherwise be dissolved if no one takes responsibility for migrating it.
...
* The appointed admin on the old team should inherit ownership of all shared collections. To do this they can [join the existing workspaces](https://community.postman.com/t/whats-new-in-postman-7-28/14094/1#heading--join-workspaces).
...
* The appointed admin can then perform the [re-import into the new team](/docs/getting-started/importing-and-exporting-data/#importing-data-into-postman).
...
* Once the last team member and data from your old team have migrated to your new one, your old team will automatically disable and you can begin [collaborating](https://www.youtube.com/watch?v=0hPUzjM-Cc8).
    ...
    * Please keep in mind items that will need to be recreated (monitors, mocks, etc) as necessary.
...
Once the last person has left, the team is automatically disabled. If there is only one admin remaining on the team, they will automatically inherit all the team workspaces data (collections and environments) in which they can perform the bulk export.
...
> Feel free to reach out to [Postman support](http://postman.com/support) if you have any questions or run into any issues setting up Postman for your team.
