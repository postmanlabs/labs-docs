...
1. In the API version **Overview** tab, next to **Mock Servers**, select **+** and choose **Create new mock server** or **Add existing mock server**.

1. Select a method for how you to base your mock server:

   * **Generate from API schema**: To create a mock server based on a collection generated from your schema, enter a collection name, and configure how the collection will be generated by clicking **Show advanced settings**
   * **Use an existing collection**: Select a collection from the drop-down list.
   * **Create a new collection**: Enter the requests your collection will contain.
1. Select **Generate Collection and Continue**.
1. Configure your [mock details](#configuring-mock-details).
