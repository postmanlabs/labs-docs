...
You can use Postman monitors to observe the performance and availability of your APIs. After you link a collection-based monitor or uptime monitor, you can view monitor results right in the API Builder.
