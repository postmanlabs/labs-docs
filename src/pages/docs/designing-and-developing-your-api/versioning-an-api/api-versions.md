...
Publish your API to share the current state of your API with consumers. You can select the linked elements (collections and environments) to include with your published API.
...
1. On the API's overview, under **Publish your API to consumers**, select **Publish API**.

    <img alt="Publishing an API" src="https://assets.postman.com/postman-docs/v10/publish-api-to-consumers-v10.jpg" width="442px" />
...
1. On the API's overview, under **Published Versions**, select **Publish**.

    <img alt="Publishing an updated API version" src="https://assets.postman.com/postman-docs/v10/published-api-version-v10.jpg" width="442px" />
