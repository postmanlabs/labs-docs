...
You can also configure how the collection should be generated by clicking on **Show advanced settings**.
...
* **Generate collection from schema**: To create a mock server based on a collection generated from your schema, enter a name, configure how the collection should be generated by clicking on **Show advanced settings**, and click **Generate Collection and Continue**
...
Specify a name, configure how the collection should be generated by clicking on **Show advanced settings**, and click **Generate Collection and Continue**.
...
* **Create new test suite**: Enter a name, configure how the collection should be generated by clicking on **Show advanced settings**, and click **Generate Test Suite**.
...
* **Create new integration test**: Enter a name, configure how the collection should be generated by clicking on **Show advanced settings**, and click **Generate Integration Test**.
...
* **Create new contract test**: Enter a name, configure how the collection should be generated by clicking on **Show advanced settings**, and click **Generate Contract Test**.
...
Specify a name for the collection, configure how the collection should be generated by clicking on **Show advanced settings**, then click **Generate Collection and Continue**.
