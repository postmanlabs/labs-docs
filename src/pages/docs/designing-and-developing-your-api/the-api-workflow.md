...
[![API Builder](https://assets.postman.com/postman-docs/v8-api-builder-overview.png)](https://assets.postman.com/postman-docs/v8-api-builder-overview.png)
...
<img alt="Create API" src="https://assets.postman.com/postman-docs/v8-create-new-api.png"/>

Click __New__ then select __API__, or click __+__ —_you will need to be signed into your Postman account_.

![New API](https://assets.postman.com/postman-docs/v8-create-api-modal.png)
...
<img alt="Edit API" src="https://assets.postman.com/postman-docs/v8-more-actions.png"/>
...
![Save Schema](https://assets.postman.com/postman-docs/v8-wrap-text.png)
...
![Schema Editor Options](https://assets.postman.com/postman-docs/v8-generate-collection-button.png)
...
![Generate Collection](https://assets.postman.com/postman-docs/v8-generate-collection-modal.png)
...
![Watch Option](https://assets.postman.com/postman-docs/v8-watch-button.png)
...
![Notification Watch API](https://assets.postman.com/postman-docs/v8-watch-notification.png)
...
![Email Notification](https://assets.postman.com/postman-docs/v8-email-watch-email.png)
