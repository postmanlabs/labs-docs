...
[![API Builder](https://assets.postman.com/postman-docs/v8-api-builder-overview.jpg)](https://assets.postman.com/postman-docs/v8-api-builder-overview.jpg)
...
<img alt="Create API" src="https://assets.postman.com/postman-docs/v8-create-new-api.jpg"/>

Click __New__ then select __API__, or click __+__ —_you will need to be signed into your Postman account_.

![New API](https://assets.postman.com/postman-docs/v8-create-api-modal.jpg)
...
<img alt="Edit API" src="https://assets.postman.com/postman-docs/v8-more-actions.jpg"/>
...
![Save Schema](https://assets.postman.com/postman-docs/v8-wrap-text.jpg)
...
![Schema Editor Options](https://assets.postman.com/postman-docs/v8-generate-collection-button.jpg)
...
![Generate Collection](https://assets.postman.com/postman-docs/v8-generate-collection-modal.jpg)
...
![Watch Option](https://assets.postman.com/postman-docs/v8-watch-button.jpg)
...
![Notification Watch API](https://assets.postman.com/postman-docs/v8-watch-notification.jpg)
...
![Email Notification](https://assets.postman.com/postman-docs/v8-email-watch-email.jpg)
