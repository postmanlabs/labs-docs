...
1. Select **Import**.
    ...
    <img alt="Importing an API definition from Azure APIM" src="https://assets.postman.com/postman-docs/v10/import-definition-from-azure-apim-v10.jpg" width="523px"/>
