...
1. If you want your collection to run using an environment, make the environment active by selecting it from the environment selector. You can also select one from __Environments__ in the sidebar.
