...
//replace with new template details screenshot//
...
//replace with new publish as screenshot showing all publish options on one page //
...
// replace with new enable public profile option //
...
// replace with personal profile preview with the pencil icon to change the profile visible.//
...
// replace with screenshot of new template published page //
