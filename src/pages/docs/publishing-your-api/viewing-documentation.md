...
Each request entry has a description of the request, the method and URL, the required authorization type, and any headers or parameters. You will also see sample client code for the request, along with example response bodies and headers.
