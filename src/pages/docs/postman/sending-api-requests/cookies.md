...
> You cannot override cookie headers directly in the __Headers__ tab. To change a cookie header, alter your setup in __Cookies__ (or remove cookies and set your request headers manually).
