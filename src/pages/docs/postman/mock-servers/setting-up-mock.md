...
In the case of a service outage, you will get a 502/503/504 response. Please subscribe and check our [status page](https://status.postman.com/) for updates if you encounter this.
