...
For ease of use inside Postman, you could store your API key in an [environment variable](/docs/postman/environments-and-globals/variables/) called ``postman-api-key``. This collection automatically uses this key to make API calls.
