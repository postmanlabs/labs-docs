...
You can open the console from the button on the bottom left of Postman or selecting __View__ &gt; __Show Postman Console__. In the Postman app, you can also select **Cmd/Ctrl-Alt-C**.
