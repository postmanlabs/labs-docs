...
You can delete data that is already synced to Postman by [deleting your account](/docs/getting-started/postman-account/#deleting-your-account). Note that you must [leave all Postman teams](/docs/getting-started/postman-account/#leaving-a-team) that you're a member of prior to deleting your account
