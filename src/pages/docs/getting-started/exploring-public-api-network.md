...
To access the Public API Network, visit [postman.com/explore](https://www.postman.com/explore) or click **Explore** at the top left of Postman.

[![Postman Public API Network](https://assets.postman.com/postman-docs/public-api-network.jpg)](https://assets.postman.com/postman-docs/public-api-network.jpg)
...
* The **Search** at the top of the page searches all of Postman by default, but you can also use the search controls to limit a search to only the Public API Network.
