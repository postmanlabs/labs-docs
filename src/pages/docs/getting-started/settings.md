...
To change settings in Postman, select the settings icon <img alt="Settings icon" src="https://assets.postman.com/postman-docs/settings-icon-v8.jpg#icon" width="18px"> in the header and then select **Settings**. In the Postman Desktop app, you can also select **⌘+Comma (,)** or **Ctrl+Comma (,)**.
