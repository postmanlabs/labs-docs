...
1. Install an authenticator app on your phone if you don't have one available, and have your password on hand.
1. Select **Continue**.
1. Enter your password and select **Verify**.
1. Link your authenticator app by scanning the QR code, then enter the 6 digit authentication code generated by your app and select **Next**.
