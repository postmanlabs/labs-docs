...
* Explore [workspaces, collections, and more](https://www.postman.com/explore) that you can try out inside Postman, like the following:
    ...
    * [**Postman Training**](https://bit.ly/postman-training)–Learn APIs 101, Testing and Automation, API Adoption, and API First, earning [Postman badges](https://postman-api-badges).
