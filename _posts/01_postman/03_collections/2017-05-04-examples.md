...
[Saving responses](/docs/postman/sending_api_requests/responses){:target="_blank"} has been a Postman feature for a long time. Over time our users wanted to edit these responses before saving them, and add new responses. We created Examples to provide that functionality.
