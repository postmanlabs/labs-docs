...
You cam publish Postman [API documentation](/docs/postman/api_documentation/intro_to_api_documentation) to the web with a single click. Examples display in your API documentation and provide additional details and clarification for your API. 

And you can edit these examples with real-time updates to the documentation!
