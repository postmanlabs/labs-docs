...
Postman generates and hosts browser-based API documentation for your collections automatically in real-time. Each collection has a private and public documentation view. Postman generates these views in real-time with data that is synced in the servers. 
