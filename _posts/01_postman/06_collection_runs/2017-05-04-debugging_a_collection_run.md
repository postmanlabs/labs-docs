...
You can control which bodies show up in this tooltip by using the `Log responses` dropdown when [starting a run](https://postmanlabs.atlassian.net/wiki/pages/resumedraft.action?draftId=58498843&draftShareId=0b5449c6-a1ce-4edf-a055-7427875d5b8b).

### Debugging using the Postman Console

Debugging using the Postman Console requires you to have the console open before you start your run. You can read about the Postman Console [here](https://www.getpostman.com/docs/Logging+and+troubleshooting+Postman).
