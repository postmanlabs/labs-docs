...
Log in to [HipChat](https://www.hipchat.com/sign_in){:target="_blank"} and head over to the room where you want Postman to send you messages. Click on the `Add Integration` button on the right sidebar.
