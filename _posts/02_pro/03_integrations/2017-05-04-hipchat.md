...
1. In the [Integrations](https://app.getpostman.com/dashboard/integrations){:target="_blank"} page, find HipChat from a list of Postman’s 3rd party Integrations for Postman Pro users.
...
The Team Activity Feed is where you can monitor your team’s API development and track changes being made. This integration updates you on all of your Collection edits within HipChat itself so that you don’t have to go back into the Postman app to review your team’s activity.
