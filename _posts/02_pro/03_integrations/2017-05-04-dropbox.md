...
1. In the [Integrations page](https://app.getpostman.com/dashboard/integrations){:target="_blank"}, find Dropbox from a list of Postman's 3rd party Integrations for Postman Pro users.
