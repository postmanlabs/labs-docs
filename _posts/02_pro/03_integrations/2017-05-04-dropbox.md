...
<ol start="2">
  <li>Click the **View Details** button to see information about Dropbox. </li>
</ol>
...
<ol start="3">
  <li>Click the <b>Add Integration</b> button to display the page that lets you authorize a backup of your Postman collections. </li>
</ol>
...
<ol start="4">
  <li>Click the <b>Authorize</b> button so Postman Pro can access to its own folder inside your Dropbox. </li>
</ol>
