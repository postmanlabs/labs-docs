...
To change your plan, go to the [Billing Overview](https://the.postman.co/billing/overview){:target="_blank"} page. You will see different actions for changing your plan, depending on whether you’re on the Pro (Annual) or Pro (Monthly) plan.
...
In the [Billing Overview](https://the.postman.co/billing/overview){:target="_blank"} page, click the **Add User Slots** button to increase the size of our team
