...
In the [Workplaces dashboard](https://app.getpostman.com/dashboard), select a Workspace and click the **Add to workspace** button. The personal Workspaces view appears by default. Click "Team" to add collections or environments to team Workspaces.
...
[![another workspace](https://assets.postman.com/postman-docs/WS-add-another-workspace.png)](https://assets.postman.com/postman-docs/WS-add-another-workspace.png)
...
[![elements list](https://assets.postman.com/postman-docs/WS-add-WS-results-list.png)](https://assets.postman.com/postman-docs/WS-add-WS-results-list.png)
...
[![remove sidebar](https://assets.postman.com/postman-docs/WS-remove-WS-via-sidebar.png)](https://assets.postman.com/postman-docs/WS-remove-WS-via-sidebar.png)
...
[![remove dashboard](https://assets.postman.com/postman-docs/WS-publish-or-removepWS.png)](https://assets.postman.com/postman-docs/WS-publish-or-removepWS.png)

### Deleting Workspaces

When you delete an element, you erase its existence in Postman. 

To delete a Workspace, go to the [Workspaces dashboard](https://app.getpostman.com/dashboard) and select a Workspace. In this example, we select a team Workspace to delete.

Click the ***Ellipsis (...)*** button for the element you want to delete and select "Delete".

[![delete workspace menu](https://assets.postman.com/postman-docs/WS-elipsis-menu-team.png)](https://assets.postman.com/postman-docs/WS-elipsis-menu-team.png)
...
[![join ws menu](https://assets.postman.com/postman-docs/WS-join-WS-mainScreen-menu.png)](https://assets.postman.com/postman-docs/WS-join-WS-mainScreen-menu.png)

In the Collections view, click the **Join** button.

[![join two](https://assets.postman.com/postman-docs/WS-join-second-step.png)](https://assets.postman.com/postman-docs/WS-join-second-step.png)
...
In the [Workspaces dashboard](https://app.getpostman.com/dashboard), select a personal Workspace you want to share. Next, click the ***Ellipsis (...)*** button and select "Share".

[![](https://assets.postman.com/postman-docs/WS-elipsis-menu-personal.png)](https://assets.postman.com/postman-docs/WS-elipsis-menu-personal.png)

In "Share a personal workspace", select the users with whom you want to share the Workspace from the "Members" dropdown menu.

[![share personal](https://assets.postman.com/postman-docs/WS-share-personal-WS.png)](https://assets.postman.com/postman-docs/WS-share-personal-WS.png)

Click the **Share this workplace** button.  Your shared Workspace appears in team Workspaces.

### Sharing collections in Workspaces

Postman enables you to share your collections in Workspaces from the Postman app and the [Workspaces dashboard](https://app.getpostman.com/dashboard). 
...
[![share sidebar](https://assets.postman.com/postman-docs/WS-share-collection-sidebar.png)](https://assets.postman.com/postman-docs/WS-share-collection-sidebar.png)
...
[![share collections](https://assets.postman.com/postman-docs/WS-share-collections-in+WS.png)](https://assets.postman.com/postman-docs/WS-share-collections-in+WS.png)
...
[![share embed-rip](https://assets.postman.com/postman-docs/WS-embed-a-collection.png)](https://assets.postman.com/postman-docs/WS-embed-a-collection.png)
...
[![share get link](https://assets.postman.com/postman-docs/WS-getLink-collections.png)](https://assets.postman.com/postman-docs/WS-getLink-collections.png)
...
[![details personal](https://assets.postman.com/postman-docs/WS-view-details-personal.png)](https://assets.postman.com/postman-docs/WS-view-details-personal.png)
...
In the [Workspaces dashboard](https://app.getpostman.com/dashboard), select a personal or team Workspace and click the ***Ellipsis (...)*** button. 
...
[![share elements](https://assets.postman.com/postman-docs/WS-share-elements-dashboard.png)](https://assets.postman.com/postman-docs/WS-share-elements-dashboard.png)

In "Share this collection", select the Workspace of which you want to share this collection, and click the **Share** button.

[![share elements-collections](https://assets.postman.com/postman-docs/WS-share-elements-collection.png)](https://assets.postman.com/postman-docs/WS-share-elements-collection.png)

### Publishing Workspaces

Postman enables you to [publish your collection](/docs/postman/api_documentation/intro_to_api_documentation) and make it availabe to anyone with the published link.
...
[![pub workspace](https://assets.postman.com/postman-docs/WS-publish-or-removepWS.png)](https://assets.postman.com/postman-docs/WS-publish-or-removepWS.png)
...
[![pub workspace2](https://assets.postman.com/postman-docs/WS-publish-collection.png)](https://assets.postman.com/postman-docs/WS-publish-collection.png)
...
In the [Workspaces dashboard](https://app.getpostman.com/dashboard), select a Workspace, click the ***Ellipsis (...)*** button, and select "Edit Description".
