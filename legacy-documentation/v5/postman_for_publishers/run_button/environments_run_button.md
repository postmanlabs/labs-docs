...
Including a shared environment with a shared collection can prompt users to input their own personal information with their own version of the template.  
