...
For ease of use inside Postman, you could store your API key in an [environment variable](https://learning.getpostman.com/docs/postman/environments_and_globals/variables/) called ``postman_api_key`` and this collection will automatically use it to make API calls.
